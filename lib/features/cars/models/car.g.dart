...
void _carSerialize(
  ...
  writer.writeLong(offsets[1], object.kilometers);
...
Car _carDeserialize(
  ...
  final object = Car(
    ...
    kilometers: reader.readLong(offsets[1]),
...
extension CarQueryFilter on QueryBuilder<Car, Car, QFilterCondition> {
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> kilometersEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> kilometersGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> kilometersLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Car, Car, QAfterFilterCondition> kilometersBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension CarQuerySortBy on QueryBuilder<Car, Car, QSortBy> {
  ...
  QueryBuilder<Car, Car, QAfterSortBy> sortByKilometers() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'kilometers', Sort.asc);
    });
  }

  QueryBuilder<Car, Car, QAfterSortBy> sortByKilometersDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CarQuerySortThenBy on QueryBuilder<Car, Car, QSortThenBy> {
  ...
  QueryBuilder<Car, Car, QAfterSortBy> thenByKilometers() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'kilometers', Sort.asc);
    });
  }

  QueryBuilder<Car, Car, QAfterSortBy> thenByKilometersDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'kilometers', Sort.desc);
    });
  }
...
extension CarQueryWhereDistinct on QueryBuilder<Car, Car, QDistinct> {
  ...
  QueryBuilder<Car, Car, QDistinct> distinctByKilometers() {
    return QueryBuilder.apply(this, (query) {
...
extension CarQueryProperty on QueryBuilder<Car, Car, QQueryProperty> {
  ...
  QueryBuilder<Car, int, QQueryOperations> kilometersProperty() {
    return QueryBuilder.apply(this, (query) {
