...
Expense _expenseDeserialize(
  ...
  final object = Expense(
    ...
    carId: reader.readLong(offsets[1]),
...
const _ExpensetypeValueEnumMap = {
  0: ExpenseType.service,
  1: ExpenseType.fuel,
  2: ExpenseType.insurance,
  3: ExpenseType.inspection,
  4: ExpenseType.other,
};
...
extension ExpenseQueryFilter
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> carIdEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'carId',
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> carIdGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> carIdLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Expense, Expense, QAfterFilterCondition> carIdBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ExpenseQuerySortBy on QueryBuilder<Expense, Expense, QSortBy> {
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> sortByCarId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'carId', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> sortByCarIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQuerySortThenBy
  ...
  QueryBuilder<Expense, Expense, QAfterSortBy> thenByCarId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'carId', Sort.asc);
    });
  }

  QueryBuilder<Expense, Expense, QAfterSortBy> thenByCarIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'carId', Sort.desc);
    });
  }
...
extension ExpenseQueryWhereDistinct
  ...
  QueryBuilder<Expense, Expense, QDistinct> distinctByCarId() {
    return QueryBuilder.apply(this, (query) {
...
extension ExpenseQueryProperty
  ...
  QueryBuilder<Expense, int, QQueryOperations> carIdProperty() {
    return QueryBuilder.apply(this, (query) {
